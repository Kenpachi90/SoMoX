...
public class SoMoXProjectPreferences {
	...
	/**
	 * Ordered List of all metrics weights and according descriptions.
	 * The order is relevant for the GUI.
	 */
	public List<MetricsDetails> orderedMetricDetails;
	
	public SoMoXProjectPreferences() {
		orderedMetricDetails = new ArrayList<MetricsDetails>();
		orderedMetricDetails.add(new MetricsDetails(
				SOMOX_WEIGHT_CLUSTERING_THRESHOLD_MIN_MERGE,
				"Clustering Merge Threshold Min (Start Value)",
				"The minimal abstraction level of basic components.",
				GroupID.GROUP_MERGING));
		orderedMetricDetails.add(new MetricsDetails(
				SOMOX_WEIGHT_CLUSTERING_THRESHOLD_MAX_MERGE,
				"Clustering Merge Threshold Max (End Value)",
				"The maximal abstraction level of basic components.",
				GroupID.GROUP_MERGING));
		orderedMetricDetails
				.add(new MetricsDetails(
		...
		orderedMetricDetails.add(new MetricsDetails(SOMOX_WEIGHT_PACKAGE_MAPPING,
				"Package Mapping",
				"How much are packages component indicators?",
				GroupID.GROUP_METRICS));
		orderedMetricDetails.add(new MetricsDetails(SOMOX_WEIGHT_DIRECTORY_MAPPING,
				"Directory Mapping",
				"How much are directories component indicators?",
				GroupID.GROUP_METRICS));
		orderedMetricDetails
				.add(new MetricsDetails(
						SOMOX_WEIGHT_HIGHEST_NAME_RESEMBLANCE,
						"Highest Name Resemblance",
