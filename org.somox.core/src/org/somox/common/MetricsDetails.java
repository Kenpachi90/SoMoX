...
public class MetricsDetails {
	 ...
	 */
	public enum GroupID{GROUP_CLUSTERING, GROUP_MERGING, GROUP_METRICS};
	 ...
	 * @param groupInfo
	 */
	public MetricsDetails(String metricWeightPeferenceNameP, String metricLabelP, String metricExplanantionP, GroupID groupInfo) {
