...
public class ConfigurationDefinition {
	...
	/**
	 * The number of allowed possibleValues. A value equals to ConfigurationDefinition.MULIPLICITY_UNLIMITED means an unlimited number of possibleValues is allowed
